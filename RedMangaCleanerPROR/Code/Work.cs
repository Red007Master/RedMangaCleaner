...
class Work
{
    public static void MainVoid()
    {
        ...
        {
            Filenames = CopyImages(P.StartArguments.InputPath, P.CleaningProject.CleaningProjectDirs.SourceImages); //переробити копірнути імаги як пнг і від того працювати і забити на оріг екстенсіон
        }
